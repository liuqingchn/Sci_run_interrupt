...
BIN  = sci_run_main_run.perl sci_run_add_to_rad_zone_list.perl sci_run_compute_gap.perl sci_run_ephin_plot_main.perl sci_run_find_hardness.perl sci_run_get_ephin.perl sci_run_get_rad_zone_info.perl sci_run_get_radiation_data.perl sci_run_print_html.perl sci_run_print_top_html.perl sci_run_rad_plot.perl sci_run_wrap_script sci_run_main_script sub_html_template sci_run_print_html.perl  compute_ephin_avg.perl plot_first_page_fig.perl
